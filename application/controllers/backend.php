...
class backend extends CI_Controller {
    ...
    public function __construct() {
        ...
        if (isset($_POST) && isset($_POST['account']) && isset($_POST['pwd'])) {
        	if ($_POST['account'] == 'cooper' && $_POST['pwd'] == 'cooper') {
    ...
    public function prize(){
    	...
    	$prizes = $this->prize_info_md->getData($params,$order);
    	$data['prizes'] = $prizes;
    ...
    public function setOrder(){
        ...
        if($_POST['table']=='prize_info'):
            $this->prize_info_md->update($params,$where);
        elseif($_POST['table']=='article_info'):
            $this->article_info_md->update($params,$where);
        endif;
    }
